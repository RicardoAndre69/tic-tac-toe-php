...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col">
            ...
            <div class="row">
                <div class="col">
                    <h3 class="text-center <?= $_SERVER['active_player'] == 1 ? 'text-warning' : '' ?>"><?= $_SESSION['player_1_name']?></h3>
                ...
                <div class="col text-end">
                    <h3 class="text-center <?= $_SERVER['active_player'] == 2 ? 'text-warning' : '' ?>"><?= $_SESSION['player_2_name']?></h3>
