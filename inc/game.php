    ...
    <div class="row justify-content-center">
        <div class="col">
            ...
            <div class="row align-items-center">
                ...
                <div class="col">
                    <h3 class="text-center"><span class="text-info">MATCH</span> <?php echo $_SESSION['game_number']; ?></h3>
                </div>
            ...
            <?php if (!empty($winner)) : ?>
                <div class="text-center mt-3">
                    ...
                    <div class="text-center mt-3">
                        <a href="index.php?route=game&next=1" class="btn btn-success w-25">NEXT MATCH</a>
                    </div>
                </div>
            <?php endif; ?>

            <div class="text-center mt-3">
                <a href="index.php?route=start" class="btn btn-dark w-25">RESET</a>
            </div>
